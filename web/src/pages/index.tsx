    ...
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 items-center gap-28">
      <main>
        ...
        <div className="mt-10 flex items-center gap-2">
          <Image src={usersAvatarExampleImg} quality={100} alt="" />
        ...
        <form className="mt-10 flex gap-2" onSubmit={createPool}>
          ...
          />
          <button
            className="bg-yellow-500 px-6 py-4 rounded text-gray-900 font-bold text-sm uppercase hover:bg-yellow-700 transition duration-200"
            type="submit"
          >
            Criar meu bolão
          </button>
